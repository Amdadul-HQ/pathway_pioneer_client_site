    ...
    return (
        <section className='max-w-[1440px] mx-auto md:px-0 px-5'>
                <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
                {
                    ...
                    <p className="md:text-2xl text-xl text-[#00a2ff] mt-2 font-medium font-Bebas">{spot.country}</p>
                    <h1 className="text-[#010101] text-xl font-semibold uppercase md:text-3xl mb-4 font-Montserrat">{spot.tourists_spot_name}</h1>
